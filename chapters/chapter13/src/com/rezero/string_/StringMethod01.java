...
public class StringMethod01 {
    public static void main(String[] args) {
        ...
        //4. indexOf获取字符在字符串对象中第一次出现的索引，索引从0开始，
        //   如果找不到，返回-1
        String s1 ="wer@terwe@g";
        int index = s1.indexOf('@');
        System.out.println(index);//3,第4个
        System.out.println("weIndex = " + s1.indexOf("we"));//0

        //5. lastIndexOf获取字符在字符串中最后一次出现的索引，
        // 索引从0开始，如果找不到，返回-1
        String s2 ="wer@terwe@g@";
        int index02 = s2.lastIndexOf('@');
        System.out.println(index02);//11
        System.out.println("ter的位置 = " + s2.lastIndexOf("ter"));//4

        //6. substring 截取指定范围的子串
        String name = "hello,张三";
        // name.substring(6) 从索引6 开始截取后面所有的内容
