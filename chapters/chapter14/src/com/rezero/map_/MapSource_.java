...
public class MapSource_ {
    public static void main(String[] args) {
        ...
        // 而一个Entry 对象就有k,v EntrySet<Entry<K,V>> 即：transient Set<Map.Entry<K,V>> entrySet;
        //3. entry 中, 定义的类型是 Map.Entry, 但是实际上存放的还是 HashMap$Node
        //   这是因为 static class Node<K,V> implements Map.Entry<K,V>
        //4. 当把 HashMap$Node 对象 存放在 entrySet 就方便我们的遍历,因为Map.Entry提供了
        //   方法 K getKey();V getValue();
